...
//  NEW
  ...
  public ManageController controller;
  ...
  private void updateRadiatorState(PropertyChangeEvent evt)
  {
    ...
    if(model.getRadiator().getCurrentState() instanceof State2)
    {
      controller.stateSlider.setValue(2);
      levelLabel.setValue("2");
    }
    if(model.getRadiator().getCurrentState() instanceof State3)
    {
      model.getRadiator().getCurrentState().addPropertyChangeListener("RadiatorState", this::updateRadiatorState);
    }
  }
